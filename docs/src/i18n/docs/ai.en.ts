...
export const aiEn = {
  ...
  profile: {
    ...
    intro: [
      'The first time you enter the brain with a provider configured, NoteFlow offers a short questionnaire in four sections — <strong>Professional</strong>, <strong>Personal</strong>, <strong>Your style</strong> and <strong>Working with the AI</strong> — and turns your answers into a profile note the assistant reads as background from then on.',
