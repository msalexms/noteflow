...
export const aiEs: AiContent = {
  ...
  profile: {
    ...
    intro: [
      'La primera vez que entras al cerebro con un proveedor configurado, NoteFlow te ofrece un cuestionario corto en cuatro secciones — <strong>Professional</strong>, <strong>Personal</strong>, <strong>Your style</strong> y <strong>Working with the AI</strong> — y convierte tus respuestas en una nota de perfil que el asistente lee como trasfondo a partir de entonces.',
